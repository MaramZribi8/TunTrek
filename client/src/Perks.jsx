export default function Perks({ selected, onChange }) {
  ...
  return (
    <>
      <label className="border p-4 flex rounded-2xl items-center pointer">
        <svg
      ...
      <label className="border p-4 flex rounded-2xl items-center pointer">
        ...
        >
          <path
            ...
            style={{ stroke: "#FF4500" }} // Change color here
          />
        </svg>
